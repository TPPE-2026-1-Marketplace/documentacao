...
## US01 - Registrar medidas dos modelos
**Como** gerente,  
**quero** registrar as medidas, em centímetros, de cada modelo,  
**para que** o cliente possa ter acesso aos modelos no vestuário digital.
...
- cintura
- quadril
- comprimento em centímetros para cada modelo
