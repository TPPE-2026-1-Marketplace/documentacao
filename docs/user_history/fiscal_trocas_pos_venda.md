# Fiscal, Trocas e Pós-venda

No momento, os itens originalmente levantados para esta seção foram reclassificados como requisitos não funcionais e centralizados em [Requisitos Não Funcionais](../non_functional_requirements.md).
...
| `1.3` | [Bruno Bragança](https://github.com/BrunoBReis) | Reclassificação dos itens da seção para requisitos não funcionais | 06/04/2026 |
