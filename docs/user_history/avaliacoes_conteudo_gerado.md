...
## US21 - Avaliar produtos com estrelas
...
## US22 - Comentar e enviar fotos na avaliação
**Como** cliente da loja,  
**quero** escrever um comentário detalhado e fazer o upload de fotos na minha avaliação,  
**para que** eu possa compartilhar registros que demonstrem minha experiência real com a compra para outros compradores.

## US23 - Moderar avaliações de produtos
**Como** administrador do site,  
**quero** ter uma interface para aprovar ou excluir as avaliações recebidas,  
**para que** eu possa evitar conteúdos ofensivos, spam ou comentários irrelevantes sobre o produto.
